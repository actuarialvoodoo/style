...
Variable, function, and class names should use only lowercase letters, numbers, and `_`. 
...
```{r, eval = FALSE}
# Good
average = mean((feet / 12) + inches, 'omitnan')
sqrt(x^2 + y^2)
x = 1:10
my_struct.cool_property
...
-- this section is too R specific
